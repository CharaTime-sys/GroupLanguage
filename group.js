...
var grammar = {
    ...
    {"name": "statement", "symbols": ["var_stringAssignment"], "postprocess": id},
    ...
    {"name": "while_loop", "symbols": ["_", "while_loop$string$1", "__", "binary_expression", "_", {"literal":"{"}, "_", "while_loop$string$2", "statements", "while_loop$string$3", "_", {"literal":"}"}], "postprocess": 
        data =>{
            return {
                type      : "while_loop",
                condition : data[3],
    ...
    {"name": "expression", "symbols": ["other_expression"], "postprocess": id},
    {"name": "unary_expression", "symbols": ["number"], "postprocess": id},
    {"name": "unary_expression", "symbols": ["identifier"], "postprocess": id},
    {"name": "other_expression", "symbols": ["boolean"], "postprocess": id},
    {"name": "other_expression", "symbols": ["myNull"], "postprocess": id},
    {"name": "other_expression", "symbols": ["array"], "postprocess": id},
    ...
    {"name": "var_stringAssignment$string$1", "symbols": [{"literal":":"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "var_stringAssignment", "symbols": ["identifier", "_", "var_stringAssignment$string$1", "_", "string"], "postprocess": 
        data =>{
            return{
    ...
    {"name": "array_items", "symbols": ["baseValue"], "postprocess": data => [data[0]]},
    {"name": "array_items", "symbols": ["baseValue", {"literal":","}, "array_items"], "postprocess": (data) => [data[0], ...data[2]]},
    {"name": "baseValue", "symbols": ["number"], "postprocess": id},
    {"name": "baseValue", "symbols": ["boolean"], "postprocess": id},
    {"name": "baseValue", "symbols": ["myNull"], "postprocess": id},
    {"name": "baseValue", "symbols": ["string"], "postprocess": id},
    {"name": "baseValue", "symbols": ["array"], "postprocess": id},
    ...
    {"name": "characters", "symbols": ["character", "characters"], "postprocess": 
        d => [d[0], ...d[1]]
            },
    ...
    {"name": "myNull", "symbols": ["myNull$string$1"], "postprocess": id},
    ...
    {"name": "digits$ebnf$1", "symbols": ["digits$ebnf$1", /[0-9 \t\n\r]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "digits", "symbols": ["digits$ebnf$1"], "postprocess": data => data[0].join('').replace(/\s/g, '')},
